<!-- Footer -->
    <footer class="page-footer font-small footerAaa" style="background-color: #1C2331;">
        ...
        <div class="container text-center text-md-left mt-5">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
              <p>
                <i class="fa fa-home mr-3"></i> R. José Joaquim Queiroz Júnior, 21 - Pioneiros, Ouro Branco - MG, 36420-000</p>
              <p>
                <i class="fa fa-envelope mr-3"></i> info@exemplo.com</p>
              <p>
                <i class="fa fa-phone mr-3"></i> (31) 3741-3639</p>
          ...
          <div class="container">
            ...
            <ul class="list-unstyled list-inline text-center py-4">
              <li class="list-inline-item">
                <h6 class="mb-1">Não está cadastrado?</h6>
              </li>
              <li class="list-inline-item">
                <a href="#!" class="btn btn-danger btn-rounded">Crie sua conta</a>   <a href="#!" class="btn btn-secondary btn-rounded">Entrar</a>
              </li>
            </ul>
            <!-- Call to action -->
          </div>
        ...
        <div class="footer-copyright text-center py-3">© 2018 Copyright:
          <a href="#"> Associação dos Aposentados e Pensionistas de Ouro Branco</a>
        </div>
        <!-- Copyright -->
