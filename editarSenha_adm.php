...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item">
    <a href="editarPerfil_adm.php?login=<?php echo $login; ?>" style="color: #0056C0;">Configurações</a>
  </li>
  <li class="breadcrumb-item active">Editar Senha</li>
</ol>

<form class="form-horizontal" enctype="multipart/form-data" role="form" data-toggle="validator" action="atualizarSenha_adm.php?login=<?php echo $login; ?>" method="post">
  ...
  <div class="row">
    ...
    <div class="col-8">
      <button type="submit" name="atualizeSenha" class="btn btn-primary">Atualizar</button>
    </div>
