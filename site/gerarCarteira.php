...
$sql = 'SELECT tipoLog, logradouro, complemento, numero, bairro, cidade, cep, estado, nome, idUsuario, matriculaAAA FROM associado as a,'

        . ' usuario as u WHERE matriculaAAA = ' . $matricula . ' AND a.fk_idUsuario = u.idUsuario and '

        . 'a.fk_idSituacao = 1 ORDER BY bairro, logradouro, numero;';
