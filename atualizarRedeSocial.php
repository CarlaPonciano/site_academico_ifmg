  ...
  if (isset($_SESSION["login"])) { //SE EXISTIR AUTENTICAÇÃO
    //if (($_SESSION['tipo'] == 4) || ($_SESSION['tipo'] == 6) || ($_SESSION['tipo'] == 7)){ //SE O USUÁRIO LOGADO FOR DO TIPO ADMINISTRADOR
        ...
        if (isset($_POST["atualizar"])) {
          ...
          $sql = "UPDATE redesocial SET link = '".$linkF."', mostrar = '".$mostrarF."' WHERE idRedeSocial = 1;";
          ...
          if ($con->query($sql) === TRUE) {
            ...
            $sql = "UPDATE redesocial SET link = '".$linkTw."', mostrar = '".$mostrarTw."' WHERE idRedeSocial = 2;";
            ...
            if ($con->query($sql) === TRUE) {
              ...
              $sql = "UPDATE redesocial SET link = '".$linkG."', mostrar = '".$mostrarG."' WHERE idRedeSocial = 3;";
              ...
              if ($con->query($sql) === TRUE) {
                ...
                $sql = "UPDATE redesocial SET link = '".$linkTu."', mostrar = '".$mostrarTu."' WHERE idRedeSocial = 4;";
                ...
                if ($con->query($sql) === TRUE) {
                  ...
                  $sql = "UPDATE redesocial SET link = '".$linkI."', mostrar = '".$mostrarI."' WHERE idRedeSocial = 5;";
