...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Editar Dependente</li>
</ol>
        ...
        <div class="card-body">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input readonly minlength="5" maxlength="14" type="text" class="form-control" id="cpf" placeholder="00000000000" name="cpf" value="<?php echo $cpf; ?>">
            </div>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <select readonly id="parentesco" name="parentesco" class="form-control">
                <?php
            ...
            <div class="form-group col-md-6">
              ...
              <select readonly id="agregado" name="agregado" class="form-control">
                <?php
                    if ($agregado == 0) {
                ?>
