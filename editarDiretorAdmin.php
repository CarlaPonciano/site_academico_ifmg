    ...
    if (isAdmin($_SESSION['tipo'])){ //SE O USUÁRIO LOGADO FOR DO TIPO ADMINISTRADOR
      ...
      if (!isset($_GET['id'])) { //se não tiver nenhum id passado pela url deve-se redirecionar o usuário para a página inicial
        ...
        if (isset($_POST["atualizar"])) {
            ...
            $sql = 'UPDATE diretoria SET nome = "' . $nome . '", email = "' . $email . '", descricao = "' . $descricao . '", cargo = "' . $cargo . '", img = "' . $img . '", autor = ' . $autor . ', dataAlteracao = CURRENT_TIME(), autorAprovacao = ' . $autor . ', dataAprovacao = CURRENT_TIME() WHERE idDiretor = ' . $id . ';';
          ...
          <div class="row">
            <div class="col-md-12"> 
              ...
              <div class = "post">
                ...
                <hr>
                <form class="form-horizontal" method="POST" action="editarDiretorAdmin.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <img crop-image-diretor src="upload/img-diretor/<?php echo $img; ?>" alt=""></label>
                    <div class="col-sm-12">
