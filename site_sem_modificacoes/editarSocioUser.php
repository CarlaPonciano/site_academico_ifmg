...
<ol class="breadcrumb">
  <li class="breadcrumb-item">
    <a href="exibirSocio.php?matricula=<?php echo $matricula; ?>" style="color: #0056C0;">Meus Dados</a>
  </li>
        ...
        <div class="card-body">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input readonly type="text" class="form-control" id="nome" placeholder="Nome completo" name="nome" required value="<?php echo $nome; ?>">
            </div>

            <div class="form-group col-md-6">
              <label for="dataNascimento">Data de Nascimento</label>
              <input readonly type="date" class="form-control" id="dataNascimento" max="<?php echo date("Y-m-d"); ?>" min="1900-01-01" placeholder="dd/mm/aaaa" name="dataNascimento" value="<?php echo $dataNascimento; ?>">
            </div>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input readonly type="text" class="form-control" id="mae" placeholder="Nome completo" name="mae" value="<?php echo $mae; ?>">
            </div>
            ...
            <div class="form-group col-md-6">
              ...
              <input readonly type="text" class="form-control" id="pai" placeholder="Nome completo" name="pai" value="<?php echo $pai; ?>">
            </div>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <select readonly id="genero" name="genero" class="form-control">
                <?php
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input readonly minlength="5" maxlength="12" type="text" class="form-control" id="rg" placeholder="MG00000000" name="rg" value="<?php echo $rg; ?>">
            </div>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <select readonly id="nacionalidade" name="nacionalidade" class="form-control">
                <?php
            ...
            <div class="form-group col-md-6">
              ...
              <input readonly type="text" class="form-control" id="naturalidade" placeholder="Naturalidade" name="naturalidade" value="<?php echo $naturalidade; ?>">
            </div>
