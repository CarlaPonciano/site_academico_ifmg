<?php
  ...
  if (isset($_POST["atualizar"])) {
    ...
    $sql = 'UPDATE perfil SET senha="' . $senha .'" WHERE idPerfil = ' . $id . ';';
...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header"><a class="navbar-brand mr-1" href="index.php"><img class="img-fluid rounded" src="imagens/logo-aaa-preto.png" alt="" style="height: 20px;"></a>Redefinir Senha</div>
      <div class="card-body">
        <form data-toggle="validator" method="post" action="redefinirSenhaAdm.php?id=<?php echo $id; ?>" id="formlogin" name="formlogin">
