    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="inserirImagem.php" method="post" data-toggle="validator" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-12">
              <textarea maxlength="200" class="form-control" id="legenda" name="legenda"></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-12">
              <input type="text" placeholder="Ex.: http://aapob.com.br/" class="form-control" id="link" name="link">
            </div>
          </div>
                    ...
                    <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="atualizarImagem.php?id=<?php echo $idImagem;?>" method="post" data-toggle="validator" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            <label class="control-label col-sm-12" for="legenda">Legenda:</label>
                            <div class="col-sm-12">
                              <textarea maxlength="200" class="form-control" id="legenda" name="legenda"><?php echo $legenda; ?></textarea>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            <label class="control-label col-sm-12" for="link">Ao clicar na imagem, redirecionar para:</label>
                            <div class="col-sm-12">
                              <input type="text" placeholder="Ex.: http://aapob.com.br/" class="form-control" id="link" name="link" value="<?php echo $link; ?>">
                            </div>
                          </div>
