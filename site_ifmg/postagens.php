<?php
  ...
  $sqlSecao = "SELECT * FROM secaoposts WHERE id = $idSecao;";

  $resultSecao = $conn->query($sqlSecao);
...
<!-- Page Content -->
    <div class="container">
      ...
      <?php
        ...
        if (isset($_SESSION['email'])){
          ...
          if ($_SESSION['tipo'] ==2){
            ...
            $sqlPostsPendentes = "SELECT aprovacao, cadastro FROM postpendente WHERE aprovacao = 0 AND cadastro = 0 AND SecaoPosts_id = " . $idSecao;
      ...
      <?php
        ...
        $SQL = "SELECT idPost, titulo, conteudo, img, nome, dataPostagem FROM post JOIN usuario ON autorAlteracao = usuario.id WHERE cadastro = 1 AND SecaoPosts_id = " . $idSecao . " ORDER BY dataPostagem DESC LIMIT $inicio, $quantidade;";
                  ...
                  <div class="col-lg-6">
                    ...
                    if (isset($_SESSION['email'])){
                      if ($_SESSION['tipo'] == 2){
                        ...
                        $sqlPostPendente = "SELECT aprovacao FROM postpendente WHERE idPostPendente = $idPost";

                        $resultPostPendente = $conn->query($sqlPostPendente);
      ...
      $sqlTotalRegistros = "SELECT COUNT(idPost) AS totalRegistros FROM post WHERE SecaoPosts_id = " . $idSecao . ";";
